...
########################################
host = "prj3udacity.postgres.database.azure.com"
user = "hakey94"
password = "123456aA@"
...
cursor = conn.cursor()
cursor.execute(f"DROP DATABASE IF EXISTS prj3udacitydb")
cursor.execute(f"CREATE DATABASE prj3udacitydb")
